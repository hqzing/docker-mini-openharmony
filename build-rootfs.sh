...
mkdir system-tmp
mount -o loop openharmony-source-code/out/rk3568/packages/phone/images/system.img system-tmp
cp -r system-tmp system
umount system-tmp
rm -rf system-tmp
mkdir ramdisk
cp openharmony-source-code/out/rk3568/packages/phone/images/ramdisk.img ramdisk/ramdisk.img.gz
cd ramdisk
